...
from api.yolo.utils import TryExcept, emojis
from api.yolo.utils.downloads import curl_download, gsutil_getsize
from api.yolo.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from api.yolo.models.common import AutoShape, DetectMultiBackend
